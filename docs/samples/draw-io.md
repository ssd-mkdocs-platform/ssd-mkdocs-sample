...
**Draw.ioはどうしても必要な理由があるときのみ使用してください。**
...
基本的な図（フローチャート、シーケンス図、状態遷移図など）は[Mermaid](mermaid.md)を使用してください。
...
Draw.ioで作成するファイルは`.drawio.svg`形式を使用します。
...
Draw.ioファイルは、関連する文書と同じディレクトリに配置します。
